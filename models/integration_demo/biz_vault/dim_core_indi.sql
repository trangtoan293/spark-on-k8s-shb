...
SELECT 
    ...
    sat.CUS_NAME_1      AS KDI2,
    CAST(NULL AS STRING) AS KDI3,
    CAST(NULL AS STRING) AS KDI4,
    sat.CUS_GENDER AS KDI5,
    CAST(NULL AS STRING) AS KDI6,
    sat.CUS_BIRTH_INCORP_DATE AS KDI7,
    sat.CUS_NATIONALITY AS KDI8,
    ...
    sat.CUS_ADDRESS AS KDI14_02,
    CAST(NULL AS STRING) AS KDI14_03,
    CAST(NULL AS STRING) AS KDI14_04,
    sat.CUS_STREET AS KDI14_05,
    CAST(NULL AS STRING) AS KDI14_06,
    sat.CUS_NATIONALITY AS KDI15,
    CAST(NULL AS STRING) AS KDI16,
    sat.CUS_MOBILE_NUMBER AS KDI17,
    CAST(NULL AS STRING) AS KDI18,
    sat.CUS_EMAIL_1 AS KDI19,
    CAST(NULL AS STRING) AS KDI20,
    CASE WHEN CUS_LEGAL_DOC_NAME='NATIONAL.ID' and length(sat.CUS_LEGAL_ID) <12 THEN sat.CUS_LEGAL_ID end AS KDI21_01,
    CASE WHEN CUS_LEGAL_DOC_NAME='NATIONAL.ID' and length(sat.CUS_LEGAL_ID) <12 THEN sat.CUS_LEGAL_ISS_DATE end AS KDI21_02,
    CAST(NULL AS STRING) AS KDI21_03,
    CASE WHEN CUS_LEGAL_DOC_NAME='NATIONAL.ID' and length(sat.CUS_LEGAL_ID) >= 12 THEN sat.CUS_LEGAL_ID end  AS KDI22_01,
    CASE WHEN CUS_LEGAL_DOC_NAME='NATIONAL.ID' and length(sat.CUS_LEGAL_ID) >= 12 THEN sat.CUS_LEGAL_ISS_DATE end AS KDI22_02,
    CAST(NULL AS STRING) AS KDI22_03,
    CASE WHEN CUS_LEGAL_DOC_NAME = 'PASSPORT' THEN sat.CUS_LEGAL_ID end AS KDI23_01,
    CASE WHEN CUS_LEGAL_DOC_NAME = 'PASSPORT' THEN sat.CUS_LEGAL_ISS_DATE end AS KDI23_02,
    ...
    CUS_CREATION_DATE AS KDI52,
    CAST(NULL AS STRING) AS KDI53,
    CAST(NULL AS STRING) AS KDI54,
    hub.CUS_CUSTOMER_CODE AS KDI55,
...
{# incremental load using latest date from ref_t24_dates and > max(cob_date) of this #}
    ...
    JOIN {{ ref("sat_snp_core_indi") }} sat 
