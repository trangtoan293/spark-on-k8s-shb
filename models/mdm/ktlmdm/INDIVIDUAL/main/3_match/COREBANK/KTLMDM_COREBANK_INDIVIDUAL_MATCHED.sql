...
{# Input Table #}
{%- set validate_tbl_incre = ref('KTLMDM_COREBANK_INDIVIDUAL_VALIDATE') -%}
{%- set dup_tbl = ref('KTLMDM_COREBANK_INDIVIDUAL_DUPLICATE') -%}
{%- set auto_match_tbl = ref('KTLMDM_COREBANK_INDIVIDUAL_AUTO_MATCH') -%}
